         ...
         <div class="col-lg-8">
            <article class="entry entry-single">
                  ...
                  <div class="entry-meta">
                     <ul class="list-unstyled d-flex flex-wrap gap-4 mb-0">
                        ...
                        <li class="d-flex align-items-center">
                           <i class="bi bi-calendar3 me-2" style="color: #0dcdbd;"></i>
                        ...
                        @if ($agenda->jam_mulai)
                        <li class="d-flex align-items-center">
                           <i class="bi bi-clock me-2" style="color: #0dcdbd;"></i>
               ...
               <div class="entry-content">
                  ...
                  <div class="row mt-4">
                     <div class="col-md-6">
                        <div class="card border-0 bg-light">
                           <div class="card-body">
                              <h6 class="card-title" style="color: #0dcdbd;">
                                 <i class="bi bi-tag me-2"></i>Kategori
                              </h6>
                              <p class="card-text mb-0">
                                 <span class="badge" style="background-color: #0dcdbd;">{{ ucfirst($agenda->kategori) }}</span>
                              </p>
                           </div>
                        </div>
                     </div>
                  ...
                  {{-- Call to Action --}}
                  <div class="mt-4 p-4 text-white rounded" style="background-color: #0dcdbd;">
                     <div class="row align-items-center">
                        ...
                        <div class="col-md-4 text-md-end">
                           <a href="https://wa.me/6281234567890?text=Halo%20Admin%20Desa%20Dotte%2C%20saya%20ingin%20menanyakan%20tentang%20agenda%20{{ urlencode($agenda->judul) }}"
                  ...
                  <div class="card border-0 shadow-sm rounded-3">
                     <div class="card-header bg-white border-0 py-3">
                        <h5 class="mb-0 fw-bold">
                           <i class="bi bi-calendar-event me-2" style="color: #0dcdbd;"></i>Agenda Terbaru
                        </h5>
                     </div>
                     <div class="card-body p-4">
                        ...
                        <div class="text-center mt-3">
                           <a href="{{ route('frontend.agenda') }}" class="btn btn-sm" style="border-color: #0dcdbd; color: #0dcdbd;">
                              Lihat Semua Agenda
                           </a>
                        </div>
                     </div>
                  ...
                  <div class="card border-0 shadow-sm rounded-3">
                     ...
                     <div class="card-body p-4">
                        <div class="d-grid gap-2">
                           <a href="{{ route('pengaduan') }}" class="btn btn-sm" style="border-color: #0dcdbd; color: #0dcdbd;">
